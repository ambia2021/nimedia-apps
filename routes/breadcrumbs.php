...
// Dashboard > Expenses > Add Expenses
...
// Dashboard > Expenses > Edit Expenses
Breadcrumbs::for('expenses.edit', function (BreadcrumbTrail $trail, $quote) {
    $trail->parent('expenses');
    $trail->push(trans('admin::app.expenses.edit-title'), route('admin.expenses.edit', $quote->id));
});

// Dashboard > income
Breadcrumbs::for('income', function (BreadcrumbTrail $trail) {
    $trail->parent('dashboard');
    $trail->push(trans('admin::app.layouts.income'), route('admin.income.index'));
});

// Dashboard > income > Add income
Breadcrumbs::for('income.create', function (BreadcrumbTrail $trail) {
    $trail->parent('income');
    $trail->push(trans('admin::app.income.create-title'), route('admin.income.create'));
});

// Dashboard > income > Edit income
Breadcrumbs::for('income.edit', function (BreadcrumbTrail $trail, $quote) {
    $trail->parent('income');
    $trail->push(trans('admin::app.income.edit-title'), route('admin.income.edit', $quote->id));
});
